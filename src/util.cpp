...
const char * const BITCOIN_CONF_FILENAME = "guscoin.conf";
const char * const BITCOIN_PID_FILENAME = "guscoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Guscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Guscoin";
#else
    // Unix
    return pathRet / ".guscoin";
#endif
#endif
}
