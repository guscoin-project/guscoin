...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s guscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  guscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded guscoin transaction") + "\n" +
              "  guscoin-tx [options] -create [commands]   " + _("Create hex-encoded guscoin transaction") + "\n" +
              "\n";
